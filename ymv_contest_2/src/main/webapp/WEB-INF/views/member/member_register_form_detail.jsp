		...
		<div class="row">
			<div class="col-sm-6 col-sm-offset-3">
				...
				<form:form method="post"
					action="${initParam.root}member_register_validation.ymv?identityNo=${requestScope.memberVO.identityNo }&memberType=${requestScope.memberVO.memberType }"
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
							<input type="text" class="form-control"
								value="${requestScope.memberVO.identityNo }" readonly />
						</div>
					</div>
					<div class="form-group">
						<div class="col-sm-2">
						...
						<div class="col-sm-5">
							<form:input type="text" class="form-control" placeholder="id"
								path="id" id="id" />
							<span id="idCheck"></span> <font color="red"><form:errors
									path="id"></form:errors></font>
						</div>
					</div>
					<!-- 패스워드 -->
					<div class="form-group">
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
							<form:input type="text" class="form-control"
								placeholder="mailAddress" path="mailAddress" id="mailAddress" />
